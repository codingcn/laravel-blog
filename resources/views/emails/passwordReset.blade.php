                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" width="640">
                            ...
                            <tr style="line-height: 40px;">
                                <td style="font-size: 24px;color:#292c33;">【{{getSetting('site_title')}}】密码重置申请</td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table>
                            ...
                            <tr height="30">
                                <td style="padding-left:25px;padding-right:25px;text-indent:2em;font-size:14px;line-height:24px;font-family:'微软雅黑','黑体',arial;color:#525866;">
                                    您的账号 <strong> <a href="mailto:{{$password_reset->email}}"
                                                     target="_blank">{{$password_reset->email}}</a>
                                    </strong> 正在<a href="{{url('')}}">{{getSetting('site_title')}}</a>进行账号密码重置。
                                </td>
                            </tr>
                            <tr height="10">
                                <td></td>
                            ...
                            <tr height="30">
                                <td style="padding-left:25px;padding-right:25px;text-indent:2em;font-size:14px;line-height:24px;font-family:'微软雅黑','黑体',arial;color:#525866;">
                                    为保证您的服务正常使用，请您尽快进行重置操作。如不是本人操作请忽略。
                                </td>
                            </tr>
                            <tr height="15">
                                <td></td>
                            ...
                            <tr height="15">
                                <td style="padding-left:25px;padding-right:25px;text-indent:2em;font-size:16px;line-height:28px;font-family:'微软雅黑','黑体',arial;color: #000;">
                                    点击链接重置密码并登陆： <a
                                            href="{{url('/password/reset',$password_reset->token)}}">{{url('/password/reset',$password_reset->token)}}</a>
                                </td>
                            </tr>
                            <tr height="15">
                                <td></td>
